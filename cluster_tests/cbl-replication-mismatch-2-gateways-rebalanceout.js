...
//TODO need to add re-create bucket or wait while rebalance in completed 
// can't be used with other test for now

test("setup couchbase cluster", function(t) {
...
test(
		"rebalance out node",
		function(t) {
			var post_data = "ejectedNodes=ns_1@" + servers.vm2 +"&knownNodes=ns_1@"+ servers.vm1+",ns_1@" + servers.vm2;
			var options = {
				host : servers.vm1,
				port : port,
